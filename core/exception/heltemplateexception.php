...
class helTemplateException extends \Exception implements helException {
    /**
    ...
    public function getErrorType() {
        $sErrorType = "helTemplateException\/". $this->_sErrorType;
    ...
    private function _getErrorMessage($iErrorType) {
        ...
        //Process
        $aErrorTypes = array(
            "The Template engine needs a config object. Refer to manual.", 
            "The config object must have the helTemplateConfig Interface implemented", 
        );
